...
# =====================================================================
# GLOBAL FOOTER: LIABILITY NOTICE
# =====================================================================
st.markdown("""
<hr>
<div style="font-size: 0.85em; color: #6c757d; text-align: center; padding-bottom: 20px;">
    ⚠️ <b>IMPORTANT DESIGN CAVEAT & LIABILITY NOTICE:</b> This software platform functions strictly as an engineering calculation aid. All outputs, mechanical equipment sizing selection criteria, and pipe/duct diameters generated by this system <b>must be fully reviewed, cross-examined, and approved by a qualified Professional Engineer</b> against the primary engineering source documentation before execution. The user retains all design layout responsibilities and liability.
</div>
""", unsafe_allow_html=True)