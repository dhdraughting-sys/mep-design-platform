...
with tab_reports:
    ...
    with sub_sources:
        ...
        sources_data = [
            ...
            {"Calculation Module": "Air Valve Selection (GEV/GSV/GEFV-CE/PAV)", "Standard / Reference Guide": "HVC Supplies Series AV datasheet (official quick-selection table)", "Section / Clause Reference": "N/A", "Engineering Notes": "Real published airflow at 25dB and 35dB sound levels for each size - genuine manufacturer data, not estimated. Commonly used in toilets/bathrooms as a compact alternative to a full grille."},
            {"Calculation Module": "FCU Selection - Mitsubishi PLFY-MS-VFM2-E (Compact Cassette)", "Standard / Reference Guide": "Mitsubishi Electric official UK databook (MEES25K069)", "Section / Clause Reference": "N/A", "Engineering Notes": "Real published cooling capacity and airflow (High fan speed). Sensible capacity is an estimated 0.8 SHR - the databook doesn't split this out - confirm against Mitsubishi's detailed capacity tables if precise sensible/latent matters."},
            {"Calculation Module": "FCU Selection - Mitsubishi PKFY-MS-VLM2/VKM2-E (Wall Mounted)", "Standard / Reference Guide": "Mitsubishi Electric official UK Product Information Sheet", "Section / Clause Reference": "N/A", "Engineering Notes": "Real published total AND sensible cooling capacity (High fan speed, UK conditions) - genuine manufacturer split, not estimated."},
